...
ActiveRecord::Schema.define(version: 20180718124051) do

  create_table "custom_attributes", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "partner_attribute_id"
    t.string   "value"
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["partner_attribute_id"], name: "index_custom_attributes_on_partner_attribute_id"
